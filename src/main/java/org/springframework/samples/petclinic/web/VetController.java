...
public class VetController {
	...
	public String showVetList(Map<String, Object> model, @RequestParam(value = "message", required = false) String message) {
	...
	public String processCreationForm(@Valid Vet vet, BindingResult result, ModelMap model, 
			@RequestParam(value = "specialties", required=false) List<Specialty> specialties, RedirectAttributes redirectAttributes) {
